...
// Камеры второго NVR - используем camera_id{id} как уникальный путь
$cameras = \App\Models\Camera::where('nvr_id', 2)->where('is_active', true)->get();

foreach($cameras as $camera) {
    $pathName = "cameraid{$camera->id}";
